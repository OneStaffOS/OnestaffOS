...
export class PayrollConfigurationController {
    ...
    async createPayrollPolicy(@Body() dto: CreatePayrollPolicyDto, @Req() req: any) {
        return await this.payrollConfigurationService.createPayrollPolicy(dto, req.user.userId);
    }
    ...
    async updatePayrollPolicy(@Param('id') id: string, @Body() dto: UpdatePayrollPolicyDto, @Req() req: any) {
        return await this.payrollConfigurationService.updatePayrollPolicy(id, dto, req.user.userId);
    }
    ...
    async deletePayrollPolicy(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deletePayrollPolicy(id, req.user.userId);
    }
    ...
    async approvePayrollPolicy(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approvePayrollPolicy(id, req.user.userId);
    }
    ...
    async rejectPayrollPolicy(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectPayrollPolicy(id, req.user.userId);
    }
    ...
    async createPayGrade(@Body() dto: CreatePayGradeDto, @Req() req: any) {
        return await this.payrollConfigurationService.createPayGrade(dto, req.user.userId);
    }
    ...
    async updatePayGrade(@Param('id') id: string, @Body() dto: UpdatePayGradeDto, @Req() req: any) {
        return await this.payrollConfigurationService.updatePayGrade(id, dto, req.user.userId);
    }
    ...
    async deletePayGrade(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deletePayGrade(id, req.user.userId);
    }
    ...
    async approvePayGrade(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approvePayGrade(id, req.user.userId);
    }
    ...
    async rejectPayGrade(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectPayGrade(id, req.user.userId);
    }
    ...
    async createPayType(@Body() dto: CreatePayTypeDto, @Req() req: any) {
        return await this.payrollConfigurationService.createPayType(dto, req.user.userId);
    }
    ...
    async deletePayType(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deletePayType(id, req.user.userId);
    }
    ...
    async approvePayType(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approvePayType(id, req.user.userId);
    }
    ...
    async rejectPayType(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectPayType(id, req.user.userId);
    }
    ...
    async createAllowance(@Body() dto: CreateAllowanceDto, @Req() req: any) {
        return await this.payrollConfigurationService.createAllowance(dto, req.user.userId);
    }
    ...
    async updateAllowance(@Param('id') id: string, @Body() dto: UpdateAllowanceDto, @Req() req: any) {
        return await this.payrollConfigurationService.updateAllowance(id, dto, req.user.userId);
    }
    ...
    async deleteAllowance(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deleteAllowance(id, req.user.userId);
    }
    ...
    async approveAllowance(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approveAllowance(id, req.user.userId);
    }
    ...
    async rejectAllowance(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectAllowance(id, req.user.userId);
    }
    ...
    async createSigningBonus(@Body() dto: CreateSigningBonusDto, @Req() req: any) {
        return await this.payrollConfigurationService.createSigningBonus(dto, req.user.userId);
    }
    ...
    async updateSigningBonus(@Param('id') id: string, @Body() dto: UpdateSigningBonusDto, @Req() req: any) {
        return await this.payrollConfigurationService.updateSigningBonus(id, dto, req.user.userId);
    }
    ...
    async deleteSigningBonus(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deleteSigningBonus(id, req.user.userId);
    }
    ...
    async approveSigningBonus(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approveSigningBonus(id, req.user.userId);
    }
    ...
    async rejectSigningBonus(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectSigningBonus(id, req.user.userId);
    }
    ...
    async createTerminationBenefits(@Body() dto: CreateTerminationBenefitsDto, @Req() req: any) {
        return await this.payrollConfigurationService.createTerminationBenefits(dto, req.user.userId);
    }
    ...
    async updateTerminationBenefits(@Param('id') id: string, @Body() dto: UpdateTerminationBenefitsDto, @Req() req: any) {
        return await this.payrollConfigurationService.updateTerminationBenefits(id, dto, req.user.userId);
    }
    ...
    async deleteTerminationBenefits(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deleteTerminationBenefits(id, req.user.userId);
    }
    ...
    async approveTerminationBenefits(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approveTerminationBenefits(id, req.user.userId);
    }
    ...
    async rejectTerminationBenefits(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectTerminationBenefits(id, req.user.userId);
    }
    ...
    async createTaxRule(@Body() dto: CreateTaxRuleDto, @Req() req: any) {
        return await this.payrollConfigurationService.createTaxRule(dto, req.user.userId);
    }
    ...
    async updateTaxRule(@Param('id') id: string, @Body() dto: UpdateTaxRuleDto, @Req() req: any) {
        return await this.payrollConfigurationService.updateTaxRule(id, dto, req.user.userId);
    }
    ...
    async deleteTaxRule(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deleteTaxRule(id, req.user.userId);
    }
    ...
    async approveTaxRule(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approveTaxRule(id, req.user.userId);
    }
    ...
    async rejectTaxRule(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectTaxRule(id, req.user.userId);
    }
    ...
    async createInsuranceBracket(@Body() dto: CreateInsuranceBracketDto, @Req() req: any) {
        return await this.payrollConfigurationService.createInsuranceBracket(dto, req.user.userId);
    }
    ...
    async updateInsuranceBracket(@Param('id') id: string, @Body() dto: UpdateInsuranceBracketDto, @Req() req: any) {
        return await this.payrollConfigurationService.updateInsuranceBracket(id, dto, req.user.userId);
    }
    ...
    async deleteInsuranceBracket(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.deleteInsuranceBracket(id, req.user.userId);
    }
    ...
    async approveInsuranceBracket(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.approveInsuranceBracket(id, req.user.userId);
    }
    ...
    async rejectInsuranceBracket(@Param('id') id: string, @Req() req: any) {
        return await this.payrollConfigurationService.rejectInsuranceBracket(id, req.user.userId);
    }
