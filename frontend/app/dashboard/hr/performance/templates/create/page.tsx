            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  placeholder="e.g., Annual Performance Review 2025" required
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  placeholder="Describe the purpose and scope of this template..." required
                  rows={3}
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  placeholder="Provide instructions for managers on how to complete this appraisal..." rows={3}
                  className={styles.textarea}
                />
              </div>
            </div>
            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input
                    type="number" value={formData.ratingScale.min}
                    readOnly
                    className={styles.input}
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    type="number" value={formData.ratingScale.max}
                    readOnly
                    className={styles.input}
                    style={{ background: '#f9fafb' }}
                  />
                ...
                <div className={styles.formGroup}>
                  <label>Step</label>
                  <input
                    type="number" value={formData.ratingScale.step}
                    readOnly
                    className={styles.input}
                    style={{ background: '#f9fafb' }}
                  />
              ...
              {criteria.map((criterion, index) => (
                <div key={index} className={styles.criterionCard}>
                  <div className={styles.criterionHeader}>
                    ...
                    <button
                      type="button" onClick={() => removeCriterion(index)}
                  ...
                  <div className={styles.formRow}>
                    <div className={styles.formGroup} style={{ flex: 1 }}>
                      ...
                      <input
                        ...
                        placeholder="e.g., communication_skills" required
                        className={styles.input}
                      />
                    ...
                    <div className={styles.formGroup} style={{ flex: 1 }}>
                      <label>Weight (%) *</label>
                      <input
                        type="number" value={criterion.weight}
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <textarea
                      ...
                      placeholder="Describe what this criterion evaluates..." rows={2}
                      className={styles.textarea}
                    />
                  </div>
                </div>
