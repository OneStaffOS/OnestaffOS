/**
 * Edit Job Template Page
 * Route: /dashboard/hr/recruitment/job-templates/edit/[id]
 * HR Manager can edit existing job templates
 */
...
export default function EditJobTemplatePage() {
  ...
  const fetchTemplate = async () => {
    try {
      ...
      const response = await axios.get(`/recruitment/job-templates/${templateId}`);
      ...
      setFormData({
        ...
        qualifications: template.qualifications.length > 0 ? template.qualifications : [''],
        skills: template.skills.length > 0 ? template.skills : [''],
      });
    } catch (error: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.put(`/recruitment/job-templates/${templateId}`, payload);
      alert('Job template updated successfully!');
      router.push('/dashboard/hr/recruitment/job-templates');
    } catch (error: any) {
  ...
  if (loadingTemplate) {
    return (
      <ProtectedRoute requiredRoles={[Role.HR_MANAGER]}>
        <DashboardLayout title="Edit Job Template" role="Human Resources">
      ...
      <DashboardLayout title="Edit Job Template" role="Human Resources">
        <div className={styles.section}>
          <div style={{ marginBottom: '2rem' }}>
            ...
            <h1 style={{ marginBottom: '0.5rem' }}>Edit Job Template</h1>
