                  ...
                  <tr key={app._id}>
                    ...
                    <td>
                      <div className={styles.actionButtons}>
                        {(app.currentStage === 'offer' || app.currentStage === 'hr_interview') && 
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) => setOfferData({ ...offerData, grossSalary: parseFloat(e.target.value) || 0 })}
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) => setOfferData({ ...offerData, signingBonus: parseFloat(e.target.value) || 0 })}
