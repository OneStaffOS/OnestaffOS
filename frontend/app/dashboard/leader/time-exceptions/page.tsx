...
export default function LeaderTimeExceptionsPage() {
  ...
  const fetchExceptions = async () => {
    try {
      setLoading(true);
      // Leader sees time exceptions for their department/division
  ...
  return (
    <ProtectedRoute requiredRoles={[Role.DEPARTMENT_HEAD, Role.HR_MANAGER, Role.HR_ADMIN, Role.SYSTEM_ADMIN]}>
      <DashboardLayout title="Time Exceptions" role="Leader">
